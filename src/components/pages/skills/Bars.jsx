        ...
        <div className="text-cyan-100 min-h-[300px] bg-purple-300 flex gap-4 items-center justify-between rounded-md col-span-2 p-8 hover:scale-105 duration-300 ease-linear">
          ...
          <div className="flex items-center flex-col">
            ...
            <p className="text-xs text-left font-medium">
              ...
              koja oslobađa ograničavajuća uverenja i emocije uskladištene u
              telu. Otključajte svoj pravi potencijal i doživite duboke promene
              u svesti.{" "}
            </p>
          </div>
        </div>
        ...
        <div className="text-purple-950 min-h-[300px] bg-orange-100 row-span-2 flex flex-col items-center justify-center rounded-lg p-8 hover:scale-105 duration-300 ease-linear">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-center font-medium w-1/2">
              Iskusite umetnost Access Bars-a, neinvazivne tehnike koja aktivira
              32 tačke na glavi kako bi raspršila elektromagnetni naboj misli,
              osećanja i emocija. Uravnotežite svoju energiju, promovišete
              opuštanje i iskoristite svoju unutrašnju mudrost.
            </p>
          </div>
        </div>
        {/* 3 */}
            ...
            <div className="w-full h-1/2 bg-orange-200 rounded-lg p-8">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-xs text-center font-medium w-4/5">
                  ...
                  Čišćenjem energetskih blokada, Access Bars otvara vrata novim
                  mogućnostima i osnažuje lični rast.
                </p>
              </div>
            </div>
          ...
          <div className="hover:scale-105 duration-300 ease-linear w-1/2 h-full bg-red-200 flex flex-col items-center justify-center rounded-lg p-8">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-xs text-center font-medium w-4/5 text-purple-950">
                ...
                brigu o sebi. Duboko se opustite dok nežni dodir stimuliše Bars
                tačke, promovišući mentalnu jasnoću, smanjujući stres i
