    ...
    <Layout className="">
      ...
      <div className="p-4 flex flex-col items-center justify-center  tracking-wider">
        <p className="text-lg font-light mb-10 sm:w-[600px] lg:w-[900px] italic text-center">
          ...
          povezujemo, poboljšavamo fokus i ljubazniji smo prema sebi. Dozvolite
          nam da vas provedemo kroz osnove u našem novom pažljivom vodiču o tome
          kako meditirati.
        </p>
        ...
        <section className="my-6" id="whatismeditation">
          ...
          <p className="sm:w-[600px] lg:w-[800px]  text-base font-medium text-justify">
            ...
            <span className="block my-2">
              ...
              svesnosti. Kada obratimo pažnju na svoje disanje, učimo kako da se
              vratimo i ostanemo u sadašnjem trenutku - da se ukotvimo ovde i
              sada namerno, bez sudjenja.
            </span>
        ...
        <section className="my-6" id="whytomeditate">
          ...
          <p className="text-base font-medium text-justify sm:w-[600px] lg:w-[800px] ">
            ...
            treba da donesemo bolje izbore za sebe, svoje porodice i naše
            zajednice. A najvažniji alati koje možete poneti sa sobom u praksu
            meditacije su malo strpljenja, malo ljubaznosti prema sebi i udobno
            mesto za sedenje.
            <span className="block my-2">
              Kada meditiramo, ubrizgavamo dalekosežne i dugotrajne koristi u
              svoje živote. I bonus: nije vam potrebna dodatna oprema ili skupo
              članstvo.
            </span>
        ...
        <section className="my-6" id="howtomeditate">
          ...
          <p className="text-base font-medium text-justify sm:w-[600px] lg:w-[800px] ">
            ...
            <span className="block my-2">
              3) Možete sedeti u stolici sa nogama na podu, možete sedeti labavo
              prekriženih nogu, možete klečati — sve je u redu. Samo se uverite
              da ste stabilni i u poziciji u kojoj možete da ostanete neko
              vreme.
            </span>
            <span className="block my-2">
            ...
            <span className="block my-2">
              ...
              mesta. Kada primetite da vam je um odlutao – za nekoliko sekundi,
              minut, pet minuta – jednostavno vratite pažnju na dah.
            </span>
            <span className="block my-2">
              6) Ne osuđujte sebe ili opsednite sadržajem misli u kojima ste se
              izgubili. Samo se vratite.
            </span>
            <span className="block mt-2 mb-4">
              7) Kada budete spremni, nežno podignite pogled (ako su vam oči
              zatvorene, otvorite ih). Odvojite trenutak i primetite sve zvukove
              u okruženju. Obratite pažnju na to kako se vaše telo trenutno
              oseća. Obratite pažnju na svoje misli i emocije.
            </span>
            ...
            svoju pažnju, vaš um luta, vraćate je i trudite se da to učinite što
            je moguće ljubaznije (koliko puta je potrebno).
          </p>
        </section>
        {/* Besplatne meditacije */}
